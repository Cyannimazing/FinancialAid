                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            <InputError messages={formErrors.age} className="mt-2" />
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            />
                                            <InputError messages={formErrors.password} className="mt-2" />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            <InputError messages={formErrors.password_confirmation} className="mt-2" />
                                        </div>
                                    </div>
