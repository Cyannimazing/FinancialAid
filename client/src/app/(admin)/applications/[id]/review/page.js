...
const ReviewApplicationPage = () => {
    ...
    const handleStatusUpdate = async (isApproved) => {
        ...
        try {
            ...
            await fetchFacility() // Refresh facility data
    ...
    const handleDocumentView = (document) => {
        ...
        const documentUrl = `/storage/${document.document_path}`
                                ...
                                <div className="p-6">
                                    <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <dd className="mt-1 text-sm text-gray-900">{formatDate(facility.updated_at)}</dd>
                                        </div>
                                    </dl>
